...
>>>>>>> be37263 (fix: modify EIA module and upgrade it)
    ...
    noEvidenceUploaded: "Sin evidencia",
    generateExcelReport: "Generar reporte Excel",
    generatePDFReport: "Generar reporte PDF",
    controlsCompleted: "Controles completados",
    totalControls: "Total de controles",
    completenessPercentage: "Porcentaje de completitud",
    ...
    periodicBackups: "Respaldos periódicos",
    restorationTests: "Pruebas de restauración",
    logsMonitoring: "Logs y monitoreo",
    siemIdsIps: "SIEM/IDS/IPS",
    updatedAntiMalware: "Anti-malware actualizado",
    patchManagement: "Gestión de parches",
    vulnerabilityScans: "Escaneos de vulnerabilidades",
    periodicPentests: "Pentests periódicos",
    secureSDLC: "SDLC seguro",
    continuityPlanDRP: "Plan de continuidad/DRP",
    networkMonitoring: "Monitoreo de redes",
    emailProtection: "Protección de correo",
    changeManagement: "Gestión de cambios",
...
>>>>>>> be37263 (fix: modify EIA module and upgrade it)
    ...
    processingActivitiesRegistry: "Registro de actividades de tratamiento",
    arcoProcedures: "Procedimientos ARCO",
    thirdPartyContractReview: "Revisión de contratos con terceros",
    legalRiskManagement: "Gestión de riesgos legales",
    businessImpactAnalysis: "Análisis de impacto al negocio",
    securityCommittee: "Comité de seguridad",
    ...
    secureAreas: "Áreas seguras",
    visitorLogs: "Bitácoras de visitantes",
    documentSafeguarding: "Resguardo de documentos",
    equipmentProtection: "Protección de equipos",
    secureCabling: "Cableado seguro",
    facilitiesSecurityPlan: "Plan de seguridad en instalaciones",
    physicalIntrusionDetection: "Detección de intrusión física",
    surveillance24x7: "Vigilancia 24/7",
    portableHardwareLocking: "Bloqueo de hardware portátil",
    restrictedZoneSignage: "Señalización de zonas restringidas",
    keyControl: "Control de llaves",
    facilitiesMaintenance: "Mantenimiento de instalaciones",
    mobileDeviceControl: "Control de dispositivos móviles",
    secureMediaDestruction: "Destrucción segura de medios",
...
>>>>>>> be37263 (fix: modify EIA module and upgrade it)
    ...
    auditDashboard: "Compliance Indicators",
...
>>>>>>> be37263 (fix: modify EIA module and upgrade it)
    ...
    restorationTests: "Restoration tests",
    logsMonitoring: "Logs and monitoring",
    siemIdsIps: "SIEM/IDS/IPS",
    updatedAntiMalware: "Updated anti-malware",
    patchManagement: "Patch management",
    vulnerabilityScans: "Vulnerability scans",
    periodicPentests: "Periodic pentests",
    secureSDLC: "Secure SDLC",
    continuityPlanDRP: "Continuity plan/DRP",
...
>>>>>>> be37263 (fix: modify EIA module and upgrade it)
    ...
    processingActivitiesRegistry: "Processing activities registry",
    arcoProcedures: "ARCO procedures",
    thirdPartyContractReview: "Third party contract review",
    legalRiskManagement: "Legal risk management",
    ...
    secureAreas: "Secure areas",
    visitorLogs: "Visitor logs",
    documentSafeguarding: "Document safeguarding",
    equipmentProtection: "Equipment protection",
    secureCabling: "Secure cabling",
    facilitiesSecurityPlan: "Facilities security plan",
    physicalIntrusionDetection: "Physical intrusion detection",
    surveillance24x7: "24/7 surveillance",
    portableHardwareLocking: "Portable hardware locking",
    restrictedZoneSignage: "Restricted zone signage",
    keyControl: "Key control",
    facilitiesMaintenance: "Facilities maintenance",
    mobileDeviceControl: "Mobile device control",
    secureMediaDestruction: "Secure media destruction",
