export const translations = {
  es: {
    ...
    complianceScore: "Calificación de cumplimiento",
  ...
  en: {
    ...
    securityMeasuresDrawerDescription:
      "Manage and evaluate technical, administrative and physical security controls",
