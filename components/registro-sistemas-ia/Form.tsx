...
interface AISystemData {
  ...
  ownDevelopmentGeneral?: string
  ownTechnicalDocumentation?: string
...
export default function RegistryForm({ mode }: RegistryFormProps) {
  ...
  const [formData, setFormData] = useState<AISystemData>({
    ...
    ownDevelopmentGeneral: "",
    ownTechnicalDocumentation: "",
  })
          ...
          <CardContent>
            <div className="grid gap-6">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    {mode === "third-party" && (
                      <div className="space-y-2">
                        <Label htmlFor="providerName">2. Nombre del proveedor o distribuidor</Label>
                        <Input
                          id="providerName"
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="responsibleArea">
                        {mode === "third-party"
                          ? "3. ¿A qué área(s) se le asigna la titularidad?"
                          : "2. ¿A qué área(s) se le asigna la titularidad?"}
                      </Label>
                      <select
                        id="responsibleArea"
              ...
              {mode === "own" && (
                <Card>
                  <CardHeader>
                    <CardTitle>Desarrollo propio</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="grid gap-4 sm:grid-cols-2">
                      <Card>
                        ...
                        <CardContent className="space-y-2">
                          <Label htmlFor="ownDevelopmentGeneral">Descripción general</Label>
                          <Textarea
                            id="ownDevelopmentGeneral"
                            value={formData.ownDevelopmentGeneral || ""}
                            onChange={(e) => handleInputChange("ownDevelopmentGeneral", e.target.value)}
                            placeholder="Describe el desarrollo realizado"
                          />
                        </CardContent>
                      </Card>
                      <Card>
                        ...
                        <CardContent className="space-y-2">
                          <Label htmlFor="ownTechnicalDocumentation">Detalles técnicos</Label>
                          <Textarea
                            id="ownTechnicalDocumentation"
                            value={formData.ownTechnicalDocumentation || ""}
                            onChange={(e) => handleInputChange("ownTechnicalDocumentation", e.target.value)}
                            placeholder="Referencias o enlaces a la documentación técnica"
                          />
                        </CardContent>
                      </Card>
                    </div>
